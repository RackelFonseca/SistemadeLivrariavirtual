...
module.exports = class Services {
  ...
  static async FuncionarioLogin(req, res) {
    ...
    const options = {
      url: 'https://apilivraria.rackelcoelho.repl.co/login',
      method: 'POST',
      data: valores
    };
  ...
  static async FuncionarioCreate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://apilivraria.rackelcoelho.repl.co/add_funcionario',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async LivroCreate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://apilivraria.rackelcoelho.repl.co/add_livros',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async LivroListar(req, res) {
    const options = {
      url: 'https://apilivraria.rackelcoelho.repl.co/livros',
      method: 'GET',
      data: {}
    };
